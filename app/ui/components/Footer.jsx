                    ...
                    <div className='z-10 grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6'>
                        <div>
                            ...
                            <ul className='font-medium text-gray-500 dark:text-gray-400'>
                                <li className='mb-4'>
                                    <a
                                        href='https://api-sports.io/documentation/football/v3'
                        ...
                        <div>
                            ...
                            <ul className='font-medium text-gray-500 dark:text-gray-400'>
                                <li className='mb-4'>
                                    <a
                                        href='https://github.com/SoloAlessio/EPICODE_Belcastro_CapstoneProject-FrontEnd'
                                        className='hover:underline '
                                    >
                                        Github
                                    </a>
                                ...
                                <li>
                                    <a
                                        href='https://discordapp.com/users/780212544857964565'
                                        className='hover:underline'
                                    >
                                        Discord
                                    </a>
